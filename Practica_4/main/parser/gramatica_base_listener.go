...
func (s *BaseGramaticaListener) EnterCoordinates(ctx *CoordinatesContext) {}

// ExitCoordinates is called when production coordinates is exited.
func (s *BaseGramaticaListener) ExitCoordinates(ctx *CoordinatesContext) {}

// EnterCoordinate is called when production coordinate is entered.
func (s *BaseGramaticaListener) EnterCoordinate(ctx *CoordinateContext) {}

// ExitCoordinate is called when production coordinate is exited.
func (s *BaseGramaticaListener) ExitCoordinate(ctx *CoordinateContext) {}
