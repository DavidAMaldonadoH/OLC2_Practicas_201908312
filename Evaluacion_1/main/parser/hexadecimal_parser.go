...
// NewHexadecimalParser produces a new parser instance for the optional input antlr.TokenStream.
//
// The *HexadecimalParser instance produced may be reused by calling the SetInputStream method.
...
func (s *StartContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(HexadecimalListener); ok {
